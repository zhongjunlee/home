...
public class TestDemoServiceImplTest extends BaseDbUnitTest {
    ...
    public void testUpdateTestDemo_notExists() {
        ...
        // 调用, 并断言异常
        assertServiceException(() -> testDemoService.updateTestDemo(reqVO), ErrorCodeConstants.TEST_DEMO_NOT_EXISTS);
    }
    ...
    public void testDeleteTestDemo_notExists() {
        ...
        // 调用, 并断言异常
        assertServiceException(() -> testDemoService.deleteTestDemo(id), ErrorCodeConstants.TEST_DEMO_NOT_EXISTS);
    }
