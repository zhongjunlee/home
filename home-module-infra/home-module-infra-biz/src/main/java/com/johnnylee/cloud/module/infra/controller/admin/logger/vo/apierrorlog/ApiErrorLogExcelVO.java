package com.johnnylee.cloud.module.infra.controller.admin.logger.vo.apierrorlog;
...
import com.johnnylee.cloud.module.infra.enums.DictTypeConstants;
...
public class ApiErrorLogExcelVO {
    ...
    @DictFormat(com.johnnylee.cloud.module.system.enums.DictTypeConstants.USER_TYPE)
