package com.johnnylee.cloud.module.infra.controller.admin.codegen.vo.table;
...
public class DatabaseTableRespVO {
    ...
    @Schema(description = "表描述", requiredMode = Schema.RequiredMode.REQUIRED, example = "Johnny")
