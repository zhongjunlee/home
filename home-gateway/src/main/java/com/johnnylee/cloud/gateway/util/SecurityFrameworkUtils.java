package com.johnnylee.cloud.gateway.util;

import cn.hutool.core.map.MapUtil;
import com.johnnylee.cloud.framework.common.util.json.JsonUtils;
import com.johnnylee.cloud.gateway.filter.security.LoginUser;
 ...
 * 安全服务工具类
 *
 * copy from home-spring-boot-starter-security 的 SecurityFrameworkUtils 类
 *
 * @author Johnny
 */
