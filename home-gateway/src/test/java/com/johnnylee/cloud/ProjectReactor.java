...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "com.johnnylee.cloud";
    private static final String ARTIFACT_ID = "yudao";
    private static final String PACKAGE_NAME = "com.johnnylee.cloud";
    private static final String TITLE = "个人学习系统";
