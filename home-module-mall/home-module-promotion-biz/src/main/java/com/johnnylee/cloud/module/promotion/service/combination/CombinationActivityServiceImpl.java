...
import com.johnnylee.cloud.module.promotion.controller.admin.combination.vo.activity.CombinationActivityPageReqVO;
...
import com.johnnylee.cloud.module.promotion.dal.mysql.combination.CombinationActivityMapper;
import com.johnnylee.cloud.module.promotion.dal.mysql.combination.CombinationProductMapper;
...
public class CombinationActivityServiceImpl implements CombinationActivityService {
    ...
    private void validateProductConflict(Long spuId, Long activityId) {
        ...
        if (CollUtil.isNotEmpty(matchActivityList)) {
            throw ServiceExceptionUtil.exception(ErrorCodeConstants.COMBINATION_ACTIVITY_SPU_CONFLICTS);
        }
    }
    ...
    public void updateCombinationActivity(CombinationActivityUpdateReqVO updateReqVO) {
        ...
        if (ObjectUtil.equal(activityDO.getStatus(), CommonStatusEnum.DISABLE.getStatus())) {
            throw ServiceExceptionUtil.exception(ErrorCodeConstants.COMBINATION_ACTIVITY_STATUS_DISABLE_NOT_UPDATE);
        }
        // 校验商品冲突
    ...
    public void deleteCombinationActivity(Long id) {
        ...
        if (ObjectUtil.equal(activityDO.getStatus(), CommonStatusEnum.ENABLE.getStatus())) {
            throw ServiceExceptionUtil.exception(ErrorCodeConstants.COMBINATION_ACTIVITY_DELETE_FAIL_STATUS_NOT_CLOSED_OR_END);
        }
    ...
    public CombinationActivityDO validateCombinationActivityExists(Long id) {
        ...
        if (activityDO == null) {
            throw ServiceExceptionUtil.exception(ErrorCodeConstants.COMBINATION_ACTIVITY_NOT_EXISTS);
        }
        return activityDO;
    }
