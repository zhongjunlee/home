package com.johnnylee.cloud.module.trade.service.cart;
...
import com.johnnylee.cloud.module.trade.controller.app.cart.vo.*;
import com.johnnylee.cloud.module.trade.controller.app.cart.vo.*;
import com.johnnylee.cloud.module.trade.convert.cart.TradeCartConvert;
import com.johnnylee.cloud.module.trade.dal.dataobject.cart.CartDO;
import com.johnnylee.cloud.module.trade.dal.mysql.cart.CartMapper;
...
import static com.johnnylee.cloud.module.product.enums.ErrorCodeConstants.SKU_STOCK_NOT_ENOUGH;
...
public class CartServiceImpl implements CartService {
    ...
    public void updateCartCount(Long userId, AppCartUpdateCountReqVO updateReqVO) {
        ...
        if (cart == null) {
            throw ServiceExceptionUtil.exception(ErrorCodeConstants.CARD_ITEM_NOT_FOUND);
        }
        // 校验商品 SKU
