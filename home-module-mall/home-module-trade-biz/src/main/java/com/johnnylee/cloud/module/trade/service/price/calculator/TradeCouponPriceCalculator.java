...
import com.johnnylee.cloud.module.promotion.enums.common.PromotionDiscountTypeEnum;
import com.johnnylee.cloud.module.promotion.enums.common.PromotionProductScopeEnum;
import com.johnnylee.cloud.module.promotion.enums.common.PromotionTypeEnum;
...
import static com.johnnylee.cloud.module.promotion.enums.ErrorCodeConstants.COUPON_NO_MATCH_MIN_PRICE;
import static com.johnnylee.cloud.module.promotion.enums.ErrorCodeConstants.COUPON_NO_MATCH_SPU;
...
public class TradeCouponPriceCalculator implements TradePriceCalculator {
    ...
    public void calculate(TradePriceCalculateReqBO param, TradePriceCalculateRespBO result) {
        ...
        if (ObjectUtil.notEqual(result.getType(), TradeOrderTypeEnum.NORMAL.getType())) {
            throw ServiceExceptionUtil.exception(ErrorCodeConstants.PRICE_CALCULATE_COUPON_NOT_MATCH_NORMAL_ORDER);
        }
