package com.johnnylee.cloud.module.trade.service.delivery;

import com.johnnylee.cloud.framework.common.pojo.PageResult;
import com.johnnylee.cloud.module.trade.controller.admin.delivery.vo.expresstemplate.DeliveryExpressTemplateCreateReqVO;
import com.johnnylee.cloud.module.trade.controller.admin.delivery.vo.expresstemplate.DeliveryExpressTemplateDetailRespVO;
import com.johnnylee.cloud.module.trade.controller.admin.delivery.vo.expresstemplate.DeliveryExpressTemplatePageReqVO;
import com.johnnylee.cloud.module.trade.controller.admin.delivery.vo.expresstemplate.DeliveryExpressTemplateUpdateReqVO;
import com.johnnylee.cloud.module.trade.dal.dataobject.delivery.DeliveryExpressTemplateDO;
import com.johnnylee.cloud.module.trade.service.delivery.bo.DeliveryExpressTemplateRespBO;
...
public interface DeliveryExpressTemplateService {
     ...
     * 校验快递运费模板
     *
     * 如果校验不通过，抛出 {@link ServiceException} 异常
     *
