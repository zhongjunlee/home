package com.johnnylee.cloud.module.product.service.category;
...
import com.johnnylee.cloud.module.product.dal.mysql.category.ProductCategoryMapper;
    ...
    public void validateCategoryList(Collection<Long> ids) {
        ...
        ids.forEach(id -> {
            ...
            if (!CommonStatusEnum.ENABLE.getStatus().equals(category.getStatus())) {
                throw ServiceExceptionUtil.exception(ErrorCodeConstants.CATEGORY_DISABLED, category.getName());
            }
        });
    }
