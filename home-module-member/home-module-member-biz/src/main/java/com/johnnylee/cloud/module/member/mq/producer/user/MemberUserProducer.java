package com.johnnylee.cloud.module.member.mq.producer.user;

import com.johnnylee.cloud.framework.mq.core.bus.AbstractBusProducer;
import com.johnnylee.cloud.module.member.mq.message.user.UserCreateMessage;
