package com.johnnylee.cloud.module.mp.service.user;
...
import com.johnnylee.cloud.module.mp.convert.user.MpUserConvert;
...
import com.johnnylee.cloud.module.mp.dal.mysql.user.MpUserMapper;
...
import static com.johnnylee.cloud.module.mp.enums.ErrorCodeConstants.USER_NOT_EXISTS;
import static com.johnnylee.cloud.module.mp.enums.ErrorCodeConstants.USER_UPDATE_TAG_FAIL;
