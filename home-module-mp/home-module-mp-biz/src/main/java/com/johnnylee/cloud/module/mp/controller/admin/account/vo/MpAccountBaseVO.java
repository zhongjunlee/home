package com.johnnylee.cloud.module.mp.controller.admin.account.vo;
...
public class MpAccountBaseVO {
    ...
    @Schema(description = "公众号名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "Johnny")
    ...
    @Schema(description = "备注", example = "请关注Johnny，学习技术")
