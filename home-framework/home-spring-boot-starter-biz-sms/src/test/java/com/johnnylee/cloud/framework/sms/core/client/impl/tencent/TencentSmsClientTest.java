package com.johnnylee.cloud.framework.sms.core.client.impl.tencent;
...
import com.johnnylee.cloud.framework.sms.core.client.dto.SmsReceiveRespDTO;
import com.johnnylee.cloud.framework.sms.core.client.dto.SmsSendRespDTO;
...
public class TencentSmsClientTest extends BaseMockitoUnitTest {
    ...
    private final SmsChannelProperties properties = new SmsChannelProperties()
            .setApiKey(RandomUtils.randomString() + " " + RandomUtils.randomString()) // 随机一个 apiKey，避免构建报错
            .setApiSecret(RandomUtils.randomString()) // 随机一个 apiSecret，避免构建报错
            .setSignature("Johnny");
    ...
    public void testDoSendSms() throws Throwable {
        // 准备参数
        Long sendLogId = RandomUtils.randomLongId();
        String mobile = RandomUtils.randomString();
        String apiTemplateId = RandomUtils.randomString();
        List<KeyValue<String, Object>> templateParams = Lists.newArrayList(
                new KeyValue<>("1", 1234), new KeyValue<>("2", "login"));
        String requestId = RandomUtils.randomString();
        String serialNo = RandomUtils.randomString();
        // mock 方法
        SendSmsResponse response = RandomUtils.randomPojo(SendSmsResponse.class, o -> {
    ...
    public void testDoGetSmsTemplate() throws Throwable {
        // 准备参数
        Long apiTemplateId = RandomUtils.randomLongId();
        String requestId = RandomUtils.randomString();

        // mock 方法
        DescribeSmsTemplateListResponse response = RandomUtils.randomPojo(DescribeSmsTemplateListResponse.class, o -> {
        ...
        Assertions.assertEquals(SmsTemplateAuditStatusEnum.SUCCESS.getStatus(), result.getData().getAuditStatus());
    ...
    public void testConvertUnknownTemplateStatus() {
        ...
        Long templateId = RandomUtils.randomLongId();
        // 调用，并断言结果
