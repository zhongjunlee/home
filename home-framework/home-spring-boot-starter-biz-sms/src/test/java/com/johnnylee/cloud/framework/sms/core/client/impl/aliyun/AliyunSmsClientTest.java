package com.johnnylee.cloud.framework.sms.core.client.impl.aliyun;
...
public class AliyunSmsClientTest extends BaseMockitoUnitTest {
    ...
    private final SmsChannelProperties properties = new SmsChannelProperties()
            .setApiKey(RandomUtils.randomString()) // 随机一个 apiKey，避免构建报错
    ...
    public void testDoSendSms() throws ClientException {
        ...
        // mock 方法
        SendSmsResponse response = RandomUtils.randomPojo(SendSmsResponse.class, o -> o.setCode("OK"));
    ...
    public void testDoGetSmsTemplate() throws ClientException {
        ...
        String apiTemplateId = RandomUtils.randomString();
        // mock 方法
        QuerySmsTemplateResponse response = RandomUtils.randomPojo(QuerySmsTemplateResponse.class, o -> {
            o.setCode("OK");
    ...
    public void testInvoke_throwable() throws ClientException {
        ...
        // mock 方法
        ClientException ex = new ClientException("isv.INVALID_PARAMETERS", "参数不正确", RandomUtils.randomString());
