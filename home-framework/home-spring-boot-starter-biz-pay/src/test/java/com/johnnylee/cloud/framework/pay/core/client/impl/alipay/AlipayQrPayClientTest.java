...
public class AlipayQrPayClientTest extends AbstractAlipayClientTest {
    ...
    @InjectMocks
    private AlipayQrPayClient client = new AlipayQrPayClient(RandomUtils.randomLongId(), config);
    ...
    public void testUnifiedOrder_success() throws AlipayApiException {
        ...
        String qrCode = RandomUtils.randomString();
        Integer price = RandomUtils.randomInteger();
        AlipayTradePrecreateResponse response = RandomUtils.randomPojo(AlipayTradePrecreateResponse.class, o -> {
            o.setQrCode(qrCode);
            o.setSubCode("");
        });
        ...
        Assertions.assertEquals(PayOrderDisplayModeEnum.QR_CODE.getMode(), resp.getDisplayMode());
