package com.johnnylee.cloud.framework.operatelog.core.aop;
...
import com.johnnylee.cloud.framework.common.util.monitor.TracerUtils;
import com.johnnylee.cloud.framework.common.util.servlet.ServletUtils;
import com.johnnylee.cloud.framework.operatelog.core.enums.OperateTypeEnum;
import com.johnnylee.cloud.framework.operatelog.core.service.OperateLog;
...
public class OperateLogAspect {
    ...
    public Object around(ProceedingJoinPoint joinPoint, Operation operation) throws Throwable {
        ...
        com.johnnylee.cloud.framework.operatelog.core.annotations.OperateLog operateLog = getMethodAnnotation(joinPoint,
                com.johnnylee.cloud.framework.operatelog.core.annotations.OperateLog.class);
    ...
    public Object around(ProceedingJoinPoint joinPoint,
                         com.johnnylee.cloud.framework.operatelog.core.annotations.OperateLog operateLog) throws Throwable {
        return around0(joinPoint, operateLog, null);
    }

    private Object around0(ProceedingJoinPoint joinPoint,
                           com.johnnylee.cloud.framework.operatelog.core.annotations.OperateLog operateLog,
