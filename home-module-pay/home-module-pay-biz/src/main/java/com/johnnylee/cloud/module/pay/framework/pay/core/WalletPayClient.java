package com.johnnylee.cloud.module.pay.framework.pay.core;
...
import com.johnnylee.cloud.framework.pay.core.client.impl.AbstractPayClient;
import com.johnnylee.cloud.framework.pay.core.client.impl.NonePayClientConfig;
...
import static com.johnnylee.cloud.framework.common.exception.enums.GlobalErrorCodeConstants.INTERNAL_SERVER_ERROR;
...
public class WalletPayClient extends AbstractPayClient<NonePayClientConfig> {
    ...
    protected PayOrderRespDTO doGetOrder(String outTradeNo) {
        ...
        if (orderExtension == null) {
            return PayOrderRespDTO.closedOf(String.valueOf(ErrorCodeConstants.PAY_ORDER_EXTENSION_NOT_FOUND.getCode()),
                    ErrorCodeConstants.PAY_ORDER_EXTENSION_NOT_FOUND.getMsg(), outTradeNo, "");
        }
        // 关闭状态
    ...
    protected PayRefundRespDTO doGetRefund(String outTradeNo, String outRefundNo) {
        ...
        // 支付退款单不存在， 返回退款失败状态
        if (payRefund == null) {
            return PayRefundRespDTO.failureOf(String.valueOf(ErrorCodeConstants.REFUND_NOT_FOUND), ErrorCodeConstants.REFUND_NOT_FOUND.getMsg(),
                    outRefundNo, "");
        }
        // 退款失败
