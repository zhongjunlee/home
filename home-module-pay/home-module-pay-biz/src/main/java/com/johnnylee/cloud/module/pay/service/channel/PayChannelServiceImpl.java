...
import com.johnnylee.cloud.module.pay.convert.channel.PayChannelConvert;
...
import com.johnnylee.cloud.module.pay.framework.pay.core.WalletPayClient;
...
public class PayChannelServiceImpl implements PayChannelService {
    ...
    private void validPayChannel(PayChannelDO channel) {
        ...
        if (CommonStatusEnum.DISABLE.getStatus().equals(channel.getStatus())) {
            throw ServiceExceptionUtil.exception(ErrorCodeConstants.CHANNEL_IS_DISABLE);
        }
    }
