...
import com.johnnylee.cloud.module.bpm.dal.mysql.definition.BpmFormMapper;
import com.johnnylee.cloud.module.bpm.service.definition.dto.BpmFormFieldRespDTO;
...
public class BpmFormServiceTest extends BaseDbUnitTest {
    ...
    public void testUpdateForm_notExists() {
        ...
        // 调用, 并断言异常
        assertServiceException(() -> formService.updateForm(reqVO), ErrorCodeConstants.FORM_NOT_EXISTS);
    }
    ...
    public void testDeleteForm_notExists() {
        ...
        // 调用, 并断言异常
        assertServiceException(() -> formService.deleteForm(id), ErrorCodeConstants.FORM_NOT_EXISTS);
    }
