...
public class BpmUserGroupServiceTest extends BaseDbUnitTest {
    ...
    public void testUpdateUserGroup_notExists() {
        ...
        // 调用, 并断言异常
        AssertUtils.assertServiceException(() -> userGroupService.updateUserGroup(reqVO), ErrorCodeConstants.USER_GROUP_NOT_EXISTS);
    }
    ...
    public void testDeleteUserGroup_notExists() {
        ...
        // 调用, 并断言异常
        AssertUtils.assertServiceException(() -> userGroupService.deleteUserGroup(id), ErrorCodeConstants.USER_GROUP_NOT_EXISTS);
    }
