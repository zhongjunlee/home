package com.johnnylee.cloud.module.bpm.controller.admin.definition.vo.group;
...
public class BpmUserGroupBaseVO {
    ...
    @Schema(description = "描述", requiredMode = Schema.RequiredMode.REQUIRED, example = "Johnny")
