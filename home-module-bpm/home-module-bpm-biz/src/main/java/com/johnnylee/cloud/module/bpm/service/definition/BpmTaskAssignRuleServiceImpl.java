...
import com.johnnylee.cloud.framework.datapermission.core.annotation.DataPermission;
import com.johnnylee.cloud.framework.flowable.core.util.BpmnModelUtils;
import com.johnnylee.cloud.module.bpm.controller.admin.definition.vo.rule.BpmTaskAssignRuleCreateReqVO;
import com.johnnylee.cloud.module.bpm.controller.admin.definition.vo.rule.BpmTaskAssignRuleRespVO;
import com.johnnylee.cloud.module.bpm.controller.admin.definition.vo.rule.BpmTaskAssignRuleUpdateReqVO;
import com.johnnylee.cloud.module.bpm.convert.definition.BpmTaskAssignRuleConvert;
import com.johnnylee.cloud.module.bpm.dal.dataobject.definition.BpmTaskAssignRuleDO;
import com.johnnylee.cloud.module.bpm.dal.dataobject.definition.BpmUserGroupDO;
import com.johnnylee.cloud.module.bpm.dal.mysql.definition.BpmTaskAssignRuleMapper;
import com.johnnylee.cloud.module.bpm.enums.DictTypeConstants;
import com.johnnylee.cloud.module.bpm.enums.definition.BpmTaskAssignRuleTypeEnum;
...
public class BpmTaskAssignRuleServiceImpl implements BpmTaskAssignRuleService {
    ...
    public Long createTaskAssignRule(@Valid BpmTaskAssignRuleCreateReqVO reqVO) {
        ...
        if (existRule != null) {
            throw exception(ErrorCodeConstants.TASK_ASSIGN_RULE_EXISTS, reqVO.getModelId(), reqVO.getTaskDefinitionKey());
        }
    ...
    public void checkTaskAssignRuleAllConfig(String id) {
        ...
        taskAssignRules.forEach(rule -> {
            if (CollUtil.isEmpty(rule.getOptions())) {
                throw exception(ErrorCodeConstants.MODEL_DEPLOY_FAIL_TASK_ASSIGN_RULE_NOT_CONFIG, rule.getTaskDefinitionName());
            }
        });
    }
