...
import com.johnnylee.cloud.framework.common.util.object.PageUtils;
import com.johnnylee.cloud.framework.flowable.core.util.BpmnModelUtils;
import com.johnnylee.cloud.framework.web.core.util.WebFrameworkUtils;
import com.johnnylee.cloud.module.bpm.controller.admin.task.vo.task.*;
import com.johnnylee.cloud.module.bpm.controller.admin.task.vo.task.*;
import com.johnnylee.cloud.module.bpm.convert.task.BpmTaskConvert;
import com.johnnylee.cloud.module.bpm.dal.dataobject.task.BpmTaskExtDO;
import com.johnnylee.cloud.module.bpm.dal.mysql.task.BpmTaskExtMapper;
import com.johnnylee.cloud.module.bpm.enums.task.BpmCommentTypeEnum;
import com.johnnylee.cloud.module.bpm.enums.task.BpmProcessInstanceDeleteReasonEnum;
import com.johnnylee.cloud.module.bpm.enums.task.BpmProcessInstanceResultEnum;
import com.johnnylee.cloud.module.bpm.enums.task.BpmTaskAddSignTypeEnum;
import com.johnnylee.cloud.module.bpm.service.definition.BpmModelService;
import com.johnnylee.cloud.module.bpm.service.message.BpmMessageService;
...
public class BpmTaskServiceImpl implements BpmTaskService {
    ...
    private TaskEntityImpl validateAddSign(Long userId, BpmTaskAddSignReqVO reqVO) {
        ...
        if (StrUtil.isNotBlank(taskEntity.getScopeType())
            ...
            throw ServiceExceptionUtil.exception(ErrorCodeConstants.TASK_ADD_SIGN_TYPE_ERROR,
        ...
        if (CollUtil.isNotEmpty(currentAssigneeList)) {
            ...
            throw ServiceExceptionUtil.exception(ErrorCodeConstants.TASK_ADD_SIGN_USER_REPEAT, String.join(",", convertList(userList, AdminUserRespDTO::getNickname)));
        }
        return taskEntity;
    }
