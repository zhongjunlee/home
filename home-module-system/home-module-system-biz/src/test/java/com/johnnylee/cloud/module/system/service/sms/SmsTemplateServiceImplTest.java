package com.johnnylee.cloud.module.system.service.sms;
...
import com.johnnylee.cloud.framework.common.util.collection.ArrayUtils;
import com.johnnylee.cloud.framework.common.util.object.ObjectUtils;
import com.johnnylee.cloud.framework.sms.core.client.SmsClient;
import com.johnnylee.cloud.framework.sms.core.client.SmsCommonResult;
import com.johnnylee.cloud.framework.sms.core.client.dto.SmsTemplateRespDTO;
import com.johnnylee.cloud.framework.test.core.ut.BaseDbUnitTest;
import com.johnnylee.cloud.module.system.controller.admin.sms.vo.template.SmsTemplateCreateReqVO;
import com.johnnylee.cloud.module.system.controller.admin.sms.vo.template.SmsTemplateExportReqVO;
import com.johnnylee.cloud.module.system.controller.admin.sms.vo.template.SmsTemplatePageReqVO;
import com.johnnylee.cloud.module.system.controller.admin.sms.vo.template.SmsTemplateUpdateReqVO;
import com.johnnylee.cloud.module.system.dal.dataobject.sms.SmsChannelDO;
import com.johnnylee.cloud.module.system.dal.dataobject.sms.SmsTemplateDO;
import com.johnnylee.cloud.module.system.dal.mysql.sms.SmsTemplateMapper;
import com.johnnylee.cloud.module.system.enums.sms.SmsTemplateTypeEnum;
...
import static com.johnnylee.cloud.framework.common.util.date.LocalDateTimeUtils.buildBetweenTime;
import static com.johnnylee.cloud.framework.common.util.date.LocalDateTimeUtils.buildTime;
import static com.johnnylee.cloud.framework.test.core.util.AssertUtils.assertPojoEquals;
import static com.johnnylee.cloud.framework.test.core.util.AssertUtils.assertServiceException;
import static com.johnnylee.cloud.framework.test.core.util.RandomUtils.*;
import static com.johnnylee.cloud.module.system.enums.ErrorCodeConstants.*;
