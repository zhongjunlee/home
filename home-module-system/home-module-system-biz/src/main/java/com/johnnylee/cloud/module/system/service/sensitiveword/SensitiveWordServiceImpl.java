...
import com.johnnylee.cloud.module.system.convert.sensitiveword.SensitiveWordConvert;
...
import com.johnnylee.cloud.module.system.util.collection.SimpleTrie;
...
import static com.johnnylee.cloud.framework.common.util.collection.CollectionUtils.filterList;
import static com.johnnylee.cloud.framework.common.util.collection.CollectionUtils.getMaxValue;
import static com.johnnylee.cloud.module.system.enums.ErrorCodeConstants.SENSITIVE_WORD_EXISTS;
