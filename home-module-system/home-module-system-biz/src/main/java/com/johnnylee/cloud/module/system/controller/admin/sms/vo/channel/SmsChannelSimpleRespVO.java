package com.johnnylee.cloud.module.system.controller.admin.sms.vo.channel;
...
public class SmsChannelSimpleRespVO {
    ...
    @Schema(description = "短信签名", requiredMode = Schema.RequiredMode.REQUIRED, example = "Johnny")
